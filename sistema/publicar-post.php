                    ...
                    <form action="/upload-target" >   
                        <div class="row">
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" class="form-control" id="inputUser" aria-describedby="emailHelp" name="title-post" placeholder="Título">                                                        
                            </div>
                            <div class="col-md-4 form-group">
                                <label for="inputUser">Fonte</label>
                                <input type="text" class="form-control" id="inputUser" aria-describedby="emailHelp" name="fonte-post" placeholder="Fonte">                                                        
                            </div>                                     
                        </div>
                        <div class="row">
                            <div class="col-md-4 form-group">
                                <label for="inputUser">Autor</label>
                                <input type="text" class="form-control" id="inputUser" aria-describedby="emailHelp" name="autor-post" placeholder="Autor">                                                        
                            </div>
                            <div class="col-md-2 form-group">
                                <label for="inputUser">Data</label>
                                <input type="date" class="form-control" id="date" aria-describedby="emailHelp" name="data-post" placeholder="Data">                                                        
                            </div> 
                            <div class="col-md-2 form-group">
                                ...
                                <select class="custom-select mr-sm-2" id="inlineFormCustomSelect">
                                    <?php
                                        while($linha_categoria = mysqli_fetch_assoc($lista_categoria)){
                                            $idCategoria = $linha_categoria["idCategoria"];
                                            $nomeCategoria = $linha_categoria["nomeCategoria"];
                                        
                                    ?>
                                   <option value="<?php echo utf8_encode($idCategoria); ?>" name="categoria">
									    <?php echo utf8_encode($nomeCategoria); ?>
                                    </option>
                                    <?php
                                        }
                                    ?>										
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="exampleFormControlFile1">Imagem Destacada (Resolução deve ser de 640 x 426)</label>

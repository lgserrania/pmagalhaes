...
<?php
	...
	$usuario = "SELECT idUsuario, nomeUsuario, emailUsuario, senhaUsuario ";
	$usuario .= "FROM tb_usuarios ";
	$lista_usuario = mysqli_query($conecta,$usuario);
	if(!$lista_usuario){
		die("Falha na conexão com o banco!");
    }
    while($linha_usuario = mysqli_fetch_assoc($lista_usuario)){
        $nome = $linha_usuario['nomeUsuario'];
        $email = $linha_usuario['emailUsuario'];
        $senha = $linha_usuario['senhaUsuario'];
        $id = $linha_usuario['idUsuario'];
    }
?>
<!doctype html>
                ...
                <div class="orders">
                            ...
                            <div class="card" id="box-top">
                                <div class="card-body" >
                                    <ul class="list-cat" style="list-style:none; display:flex">
                                        <li><h4 class="box-title">Usuário <?php echo utf8_encode($nome) ?></h4></li>
                                        <li style="margin-left:30px;"><a href="cadastrar-usuario.php"><button class="btn btn-primary" type="button">Novo Usuário</button></a></li>
                                    </ul>
                                </div>
                    ...
                    <div class="row">
                        <div class="col form-group">
                            ...
                            <input type="text" class="form-control" id="inputUser" aria-describedby="emailHelp" value="<?php echo utf8_encode($nome) ?>">                                                        
                        </div>
                        <div class="col form-group">
                            <label for="inputUser">E-mail</label>
                            <input type="email" class="form-control" id="inputUser" aria-describedby="emailHelp" value="<?php echo $email ?>">                                                        
                        </div>
                        <div class="col form-group">
                            <label for="inputUser">Senha</label>
                            <input type="password" class="form-control" id="disabledInput" aria-describedby="emailHelp" value="<?php echo $senha ?>" disabled>                                                        
                        </div>                        
                    </div>
                    <div class="">
                        <div class="row">
                            <div class="col-md-2">
                                <a href="usuario-alterar.php?codigo=<?php echo $id?>"><button type="button" class="btn btn-primary" id="btn-alterar-user">Alterar Usuário</button></a>
                            </div>                         
                        </div>
                    </div>
                </div>

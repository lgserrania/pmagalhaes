...
<?php
	...
	$categoria = "SELECT idCategoria, nomeCategoria ";
	$categoria .= "FROM tb_categoria ";
    ...
    if(isset($_POST["deletar"])){
        $id = $_POST["id"];
        $query = "DELETE FROM tb_post WHERE idPost = $id";
...
<body>
                ...
                <ul class="nav navbar-nav" id="aside-menu">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="cadastrar-categoria.php">Cadastrar</a></li>   
                            <li><i class="fa fa-puzzle-piece"></i><a href="listar-categoria.php">Listar</a></li>   
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="">Cadastrar Artigo</a></li>
                    ...
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="card" id="box-top">
                                    <div class="card-body" >
                                        <ul class="list-cat" style="list-style:none; display:flex">
                                            <li><h4 class="box-title">Categorias Cadastradas</h4></li>
                                            <li style="margin-left:30px;"><a href="cadastrar-artigo.php"><button class="btn btn-primary" type="button">Novo Artigo</button></a></li>
                                        </ul>
                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        if($lista_posts){
                                            ...
                                            foreach($lista_posts as $post){
                                                $html .= "<tr>";
                                                $html .= "<td class='serial'>{$post['idPost']}</td>";
                                                $html .= "<td><span class='name'></span><img src='{$post['imgPost']}' class='img-fluid' alt=''></td>";
                                                $html .= "<td><span class='name'>{$post['tituloPost']}</span></td>";
                                                $html .= "<td><span class='name'>{$post['nomeCategoria']}</span></td>";
                                                $html .= "<td><span class='name'>{$post['autorPost']}</span></td>";
                                                $html .= "<td><span class='name'>{$post['dataPost']}</span></td>";
                                                $html .= "<td>";
                                                $html .= "<button class='btn btn-danger' data-toggle='modal' data-target='#exampleModal' data-id='{$post['idPost']}'>Excluir</button>";
                                                $html .= "<a href='alterar-artigo.php?id={$post['idPost']}'><button class='btn btn-primary' type='button'>Alterar</button></a>";
                                                $html .= "</td></tr>";
                                            }
                                            echo $html;
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Você Tem Certeza Que Deseja Excluir Esse Artigo?</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <span style="color:red">Os artigos excluídos não podem ser recuperados.</span>
                                                </div>
    ...
    jQuery('#exampleModal').on('show.bs.modal', function (event) {
        ...
        var htmlFooter = '<button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>';
        htmlFooter += '<button type="button" onclick="deletar(' + id + ')" class="btn btn-primary" data-dismiss="modal" aria-label="Close">Excluir</button>';
        modal.find('.modal-footer').html(htmlFooter);
    });

    function deletar(pid){
        jQuery.ajax({
            url: "listar-artigos.php",
            type: "POST",
            data:{
                deletar: true,
                id: pid

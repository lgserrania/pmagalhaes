                            ...
                            <div class="card" id="box-top">
                                    <div class="card-body" >
                                        <ul class="list-cat" style="list-style:none; display:flex">
                                            ...
                                            <li style="margin-left:30px;"><a href="cadastrar-categoria.php"><button class="btn btn-primary" type="button">Nova Categoria</button></a></li>
                                        </ul>
                                    </div>
                            ...
                            <div class="table-stats order-table ov-h">
                                <table class="table ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="serial"><?php echo ($linha_categoria["idCategoria"]);?></td>                                                   
                                            </td>
                                            <td>  <span class="name"><?php echo utf8_encode(($linha_categoria["nomeCategoria"]));?></span> </td>
                                            <td>
                                                <a href="excluir-categoria.php"><button class="btn btn-danger" type="button">Excluir</button></a>
                                            </td>
                                        </tr>
                                        <?php
                                            }

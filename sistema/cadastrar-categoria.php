                    ...
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="card" id="box-top">
                                <div class="card-body" >
                                    <h4 class="box-title">Cadastro de Categoria</h4>
                                </div>
                    ...
                    <form method="post" action="cadastrar-categoria.php">
                        <div class="row">
                            <div class="col-md-4 form-group">
                                <label for="inputUser">Nome da Categoria</label>
                                <input type="text" class="form-control" id="inputUser" aria-describedby="emailHelp" name="categoria">                                                        
                            </div>                                    
                        </div>
                        <div class="">
                            <div class="row">
                                <div class="col-md-2">
                                    <input class="btn btn-primary" value="Cadastrar Categoria" type="submit">
                                </div>                         
                            </div>
                        </div>
                    </form>

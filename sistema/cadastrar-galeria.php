...
<?php
    ...
    if(isset($_POST["idPost"])){
        $id = $_POST["idPost"];
        $imagem = $_POST["imagem"];
        $diretorio = "uploads/" . $imagem;

        $query = "INSERT INTO tb_galeria (idPost, imagem) VALUES ($id, '$diretorio')";
        $executa = mysqli_query($conecta, $query);
    }
?>
<!doctype html>
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="card" id="box-top">
                                <div class="card-body" >
                                    <h4 class="box-title">Criar Galeria</h4>
                                </div>                              
                            </div> <!-- /.card -->
                        </div>  <!-- /.col-lg-8 -->                      
                    </div>                    
                    <div class="row">
                        <div class="col-md-8">
                            <form action="upload-galeria.php" class="dropzone" id="drop">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="mr-sm-2" for="inlineFormCustomSelect">Selecione O Artigo Que Irá Receber A Galeria</label>
                                        <select class="custom-select mr-sm-2 idpost" name="idpost" id="inlineFormCustomSelect">
                                            <?php 
                                ...
                                <!-- <div class="row">
                                    <div class="col-md-2">
                                        <input class="btn btn-primary" value="Criar Galeria" type="submit">
                                    </div>
                                    <div class="col-md-2">
                                        <input class="btn btn-danger" value="Cancelar" type="submit">
                                    </div>
                                </div>                       -->
                                <div class="fallback"> 
        ...
        var myDropzone = new Dropzone("#drop", { 
            ...
            accept: function(file, done) {
                if (file.name == "olamundo.png") {
                    ...
                    jQuery.ajax({
                        url: "cadastrar-galeria.php",
                        type: "post",
                        data:{
                            idPost: jQuery(".idpost").val(),
                            imagem: file["name"]
                        },

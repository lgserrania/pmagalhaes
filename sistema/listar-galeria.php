...
<?php
	...
	$query = "SELECT idPost,tituloPost FROM tb_post";
    ...
    if(isset($_POST["excluir"])){
        $id = $_POST["id"];
        $imagem = $_POST["imagem"];
        $query = "DELETE FROM tb_galeria WHERE idPost = $id AND imagem = '$imagem'";
...
<body>
                ...
                <ul class="nav navbar-nav" id="aside-menu">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-puzzle-piece"></i><a href="listar-categoria.php">Listar Categoria</a></li>                             
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Galeria Cadastradas</h4>
                                </div>
                                <div class="card-body--">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class="ml-sm-2" for="inlineFormCustomSelect">Selecione o artigo desejado</label>
                                            <select class="custom-select mb -sm-2 idpost" name="idpost" id="inlineFormCustomSelect">
                                                <?php 
                                                foreach($listaPosts as $post){
                                                    echo "<option value= {$post['idPost']} > {$post['tituloPost']} </option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="table-stats order-table ov-h">
                                        <table class="table ">
                                            ...
                                            <tbody id="lista-imagens">
                                                ...
                                                //         $query = "SELECT tituloPost FROM tb_post WHERE idPost = ".$galeria['idPost'];
                                                //         $postagem = mysqli_query($conecta,$query);
                                                //         $post = mysqli_fetch_assoc($postagem);
                                                //         $titulo = $post["tituloPost"];
                                                //         $html = "<tr>";
                                                //         $html .= "<td class='serial'>{$galeria['idPost']}</td>";
                                                //         $html .= "<td>  <span class='name'>$titulo</span> </td>";
                                                //         $html .= "<td><a href=''><span class='btn btn-primary btn-md'>Alterar</span></a></td>";
                                                //         $html .= "</tr>";
                                                //         echo $html;
                                                //     }
                                                // }
    ...
    <script>
    jQuery(".idpost").change(function(){

        listaImagens(jQuery(".idpost").val());

    });

    function excluir(gid, gimagem){
        jQuery.ajax({
    ...
    function listaImagens(id){
        jQuery.ajax({
            ...
            success: function(retorno){
                jQuery("#lista-imagens").html(retorno);
            }
        })
    }

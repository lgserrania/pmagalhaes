...
if(isset($_POST["nomeCategoria"])){
    ...
    //exclusao
    $exclusao = "DELETE FROM tb_categoria ";
    $exclusao .= "WHERE idCategoria = {$categoriaID} ";
 ...
 $tr = "SELECT * FROM tb_categoria ";
 if(isset($_GET["codigo"])){
     $id = $_GET["codigo"];
     $tr .= "WHERE idusuario = {$id} ";
 }
 $con_categoria = mysqli_query($conecta, $tr);
 if(!$con_categoria){
     die("Erro na conexcao");
 }

 $info_categoria = mysqli_fetch_assoc($con_categoria);

 $categoria = $info_categoria["nomeCategoria"];
 $idcategoria = $info_categoria["idCategoria"];
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="card" id="box-top">
                                <div class="card-body" >
                                    <h4 class="box-title">Excluir Categoria</h4>
                                </div>
                    ...
                    <form method="post" action="excluir-categoria.php">
                        <div class="row">
                            <div class="col-md-4 form-group">
                                <label for="inputUser">Nome</label>
                                <input type="text" class="form-control" name="nomeCategoria" id="inputUser" aria-describedby="emailHelp" value="<?php echo utf8_encode($categoria) ?>">                                                        
                            </div>                                                                               
                        </div>
                        <div class="">
                            <div class="row">                               
                                <div class="col-md-2">
                                    ...
                                    <input class="btn btn-danger" type="submit" value="Excluir Categoria">
                                </div>
                            </div>
                        </div>
                    </form>

...
<?php
    ...
    if(isset($_POST["titulo"])){
        ...
        $inserir  = "INSERT INTO tb_post";
        $inserir .= "(tituloPost, fontePost, autorPost, dataPost, categoriaPost, conteudoPost, imgPost) ";
        $inserir .= "values ";
        $inserir .= "('$titulo','$fonte','$autor','$data','$categoriaPost', '$conteudo', '$imagem_diretorio') ";

        if (move_uploaded_file($imagem["tmp_name"], $diretorio . $imagem_nome)) {
            $confirma = mysqli_query($conecta, $inserir);
            if(!$confirma){
            ...
            echo "Não foi possível salvar as imagens!";
        }
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="card" id="box-top">
                                <div class="card-body">
                                    <h4 class="box-title">Cadastro do Artigo</h4>
                                </div>
                    ...
                    <form action="cadastrar-artigo.php" method="post" enctype="multipart/form-data">   
                        <div class="row">
                            <div class="col-md-4 form-group">
                                <label for="inputUser">Título do Post</label>
                                <input type="text" class="form-control" id="inputUser" aria-describedby="emailHelp" name="titulo" placeholder="Título">                                                        
                            </div>
                            <div class="col-md-4 form-group">
                                <label for="inputUser">Fonte</label>
                                <input type="text" class="form-control" id="inputUser" aria-describedby="emailHelp" name="fonte" placeholder="Fonte">                                                        
                            </div>                                     
                        </div>
                        <div class="row">
                            <div class="col-md-4 form-group">
                                <label for="inputUser">Autor</label>
                                <input type="text" class="form-control" id="inputUser" aria-describedby="emailHelp" name="autor" placeholder="Autor">                                                        
                            </div>
                            <div class="col-md-2 form-group">
                                <label for="inputData">Data</label>
                                <input type="date" class="form-control" id="inputData" aria-describedby="emailHelp" name="data" placeholder="Data">                                                        
                            </div> 
                            <div class="col-md-2 form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="categoria" id="inlineFormCustomSelect">
                                    ...
                                    ?>
                                    <option value="<?php echo utf8_encode($linha["idCategoria"]); ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="card" style="width: 18rem;">
                                    <img class="card-img-top" id='imgUp' src="#" alt="Card image cap">
                                    <div class="card-body">                                       
                                        <input type="file" name="imagem" id="imgInp" class="form-control-file">
                                        <button class="btn btn-danger" id="btnRemove" style="display: none;" type="button" id="btn-cancel">Cancelar</button>
                                    </div>
                                </div>                                
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <textarea name="conteudo" id="summernote" cols="30" rows="10"></textarea>
                            </div>
                        </div>                                                            
                                        
                        <div class="row box-confirma">
                            <div class="col-md-2">
                                <input class="btn btn-primary" value="Cadastrar Post" type="submit">
                            </div>                         
                        </div>                      
                    </form>
                </div>

...
<?php
    ...
    $lista_usuario = mysqli_query($conecta, $query);
                                    ...
                                    <div class="table-stats order-table ov-h">
                                        <table class="table ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="serial"><?php echo ($linha_usuario["idUsuario"]);?></td>                                                   
                                                    </td>
                                                    <td>  <span class="name"><?php echo utf8_encode(($linha_usuario["nomeUsuario"]));?></span> </td>
                                                    <td> <span class="product" style="text-transform: lowercase"><?php echo ($linha_usuario["emailUsuario"]);?></span> </td>
                                                    <td>
                                                        <a href="usuario.php?codigo=<?php echo $linha_usuario["idUsuario"] ?>"><span class="btn btn-primary btn-md">Listar</span></a>

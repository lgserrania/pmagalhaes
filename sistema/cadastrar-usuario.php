...
<?php
    ...
    if(isset($_POST["nome"])){
        ...
        $inserir .= "(nomeUsuario, emailUsuario, senhaUsuario) ";
        $inserir .= "values ";
                    ...
                    <form method="post" action="cadastrar-usuario.php">
                        <div class="row">
                            <div class="col form-group">
                                ...
                                <input type="text" class="form-control" id="inputUser" aria-describedby="emailHelp" name="nome">                                                        
                            </div>
                            <div class="col form-group">
                                <label for="inputUser">E-mail</label>
                                <input type="email" class="form-control" id="inputUser" aria-describedby="emailHelp" name="email">                                                        
                            </div>
                            <div class="col form-group">
                                <label for="inputUser">Senha</label>
                                <input type="password" class="form-control" id="disabledInput" aria-describedby="emailHelp" name="senha">                                                        
                            </div>                        
                        </div>
                        <div class="">
                            <div class="row">
                                <div class="col-md-2">
                                    <input class="btn btn-primary" value="Cadastrar Usuário" type="submit">
                                </div>                         
                            </div>
                        </div>
                    </form>

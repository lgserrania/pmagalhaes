...
<html class="no-js" lag="pt-BR"> 
	...
	<title>P Magalhães Consultoria | Clientes</title>
		...
		<section class="bg-header">
			<div id="fh5co-offcanvass">
				<ul>
					...
					<li class="active"><a href="../clientes/index.php">Sobre</a></li>
				...
				<div id="fh5co-wrap">
							...
							<div class="container">
								<div class="row">								
									<div class="col-md-6 fh5co-text">
										...
										<h2 class="to-animate intro-animate-1">Clientes</h2>
										...
										<p class="to-animate intro-animate-3"><a href="#" class="btn btn-primary btn-md"> Saiba Mais <img src="../images/arrow.png" class="arrow-btn"></a></p>
					...
					<div id="fh5co-main">
						...
						<div id="fh5co-features" data-section="features">
							<div class="container">
								<div class="row" id="session-one">
									<div class="col-md-8 col-md-offset-2 fh5co-section-heading text-center">
										<h2 class="fh5co-lead to-animate">Conheça Algun de Nossos Clientes</h2>
										<p class="fh5co-sub to-animate">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Necessitatibus consequuntur
											 assumenda modi blanditiis deserunt quo accusantium recusandae iure, sint dolorem animi fuga inventore nesciunt repellat dolore, laboriosam tempore itaque perferendis?</p>
									</div>
                                </div>                              
                            </div>
                                                ...
                                                <div class="owl-carousel">
                                                    ...
                                                    <div class="item">
                                                        <div class="col-md-3 col-sm-3 col-xs-4 col-xxs-12">
                                                            <figure class="fh5co-vcard"><img src="../images/cliente.png" alt="Cliente P Magalhães" class="img-responsive"></figure>
                                                        </div>
                                                        <div class="col-md-9 col-sm-9 col-xs-8 col-xxs-12">
                                                            <blockquote>
                                                                <p>&ldquo;Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ratione hic, tempora aliquid numquam eum illum adipisci esse soluta voluptatibus. Dolorum nihil, aliquam doloremque voluptate voluptates inventore aliquid sed nisi sunt.&rdquo;</p>
                                                            </blockquote>
                                                            <p class="fh5co-author fh5co-uppercase-sm"><span>Cliente A</span>, ABC Company.</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="item">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-8 col-xxs-12">
                                                            ...
                                                            <p class="fh5co-author fh5co-uppercase-sm"><span>Cliente B</span>, ABC Company.</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="item">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-8 col-xxs-12">
                                                            ...
                                                            <p class="fh5co-author fh5co-uppercase-sm"><span>Cliente C</span>, ABC Company.</p>
                                                        </div>
                                                    </div>                       
